...
const useStyles = makeStyles((theme) => ({
    ...
    dashIcon: {
        ...
        '&.cruise': {
            ...
            '&.active': {
                ...
                filter: 'drop-shadow(0 0 0.45rem rgba(0, 178, 255, 0.55))',
                textShadow: '0 0.25rem 1rem rgba(0, 178, 255, 0.45)',
            },
        },
    },
    left: {
    ...
    barIcon: {
        fontSize: 16,
        filter: 'drop-shadow(0 0 0.35rem rgba(255, 255, 255, 0.22))',
    },
}));

const getFuelGlow = (fuel) => {
    if (fuel >= 50) {
        return '0 0.25rem 0.25rem rgba(135, 218, 33, 0.25), 0 0.25rem 1rem rgba(135, 218, 33, 0.4)';
    }

    if (fuel >= 10) {
        return '0 0.25rem 0.25rem rgba(240, 147, 72, 0.25), 0 0.25rem 1rem rgba(240, 147, 72, 0.42)';
    }

    return '0 0.25rem 0.25rem rgba(255, 0, 0, 0.35), 0 0.25rem 1rem rgba(255, 0, 0, 0.55)';
};
