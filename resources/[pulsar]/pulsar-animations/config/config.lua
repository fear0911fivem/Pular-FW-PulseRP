...
Config.EnableEmoteCD = false

Config.AnimCooldown = 30 * 1000 -- ms

Config.AnimMaxEmotesCooldown = 3
...
Config.Walks = {
	...
	["Drunk 2"] = "move_m@drunk@slightlydrunk",
	["Drunk 3"] = "move_m@buzzed",
	["Drunk 4"] = "move_m@drunk@verydrunk",
	["Femme"] = "move_f@femme@",
